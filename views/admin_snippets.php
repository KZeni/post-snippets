<form method="post" action="">
    ...
    ?>
    <br>
    <table class="widefat fixed mt-20" cellspacing="0">
        <thead>
        <tr>
            <th scope="col" class="check-column" style="width: 100px;"><input type="checkbox" /></th>
    ...
    <?php endif; ?>
    <table class="widefat fixed mb-20" cellspacing="0">
        <thead>
        <tr>
            <th scope="col" class="check-column" style="width: 100px;"><input type="checkbox" /></th>
            <th scope="col" style="width: 180px;"><?php _e('Title', 'post-snippets'); ?></th>
